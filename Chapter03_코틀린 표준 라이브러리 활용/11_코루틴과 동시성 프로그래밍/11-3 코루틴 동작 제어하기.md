...
- **디스패처(Dispatcher)** : CoroutineDispatcher 라는 추상 클래스
  ...
  - dispatch : 보내다
  - 사용자로부터 코루틴 실행 요청이 들어오면 스레드 풀에있는 적절한 스레드에 코루틴을 보내줌 (알아서 쉬고있는 스레드 선택)![image-20220923233144638](../../Library/Application%20Support/typora-user-images/image-20220923233144638.png)![image-20220923233234632](../../Library/Application%20Support/typora-user-images/image-20220923233234632.png)![image-20220923233322706](../../Library/Application%20Support/typora-user-images/image-20220923233322706.png)
